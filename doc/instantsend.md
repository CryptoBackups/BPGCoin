...
This mechanism has been integrated into Bitcore-Node-BPGCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bpg-project/insight-api-bpgcoin#web-socket-api](https://github.com/bpg-project/insight-api-bpgcoin#web-socket-api)
* API: [https://github.com/bpg-project/insight-api-bpgcoin#instantsend-transactions](https://github.com/bpg-project/insight-api-bpgcoin#instantsend-transactions)
...
By default, the BPG Coin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BPG Coin daemon:
