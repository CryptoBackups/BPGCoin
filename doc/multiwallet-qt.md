...
Only requiring some minor changes is bpgcoin.cpp.
...
Changes to bpgcoin.cpp
----------------------
bpgcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
