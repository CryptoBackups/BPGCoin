    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BPG-light"), QVariant("light"));
    ui->theme->addItem(QString("BPG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BPG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BPG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BPG-traditional"), QVariant("trad"));
