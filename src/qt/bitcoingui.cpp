    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BPG Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BPGCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bpgcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BPG Coin"), this);
    aboutAction->setStatusTip(tr("Show information about BPG Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BPG Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BPGCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BPGCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bpgcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BPG Coin help message to get a list with possible BPG Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BPG Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BPGCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("BPG Coin"); // default title
