    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BPG Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BPG Coin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bpgcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BPGCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other bpgcoin, without having your coins ever leave your wallet. \
...
These denominations are 0.01 BPG, 0.1 BPG, 1 BPG and 10 BPG -- sort of like the paper money you use every day.</li> \
...
<li>When two other bpgcoin send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://bpg-project.atlassian.net/wiki/display/DOC/PrivateSend\">https://bpg-project.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BPG Coin is shutting down...") + "<br /><br />" +
