...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BPGCoinNetwork") type = BPGCoinNetwork;
    if(strType == "BPGCoinNetworkVariable") type = BPGCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BPGCoinNetwork) s = "BPGCoinNetwork";
    if(type == BPGCoinNetworkVariable) s = "BPGCoinNetworkVariable";
