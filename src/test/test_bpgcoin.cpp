...
#define BOOST_TEST_MODULE BPGCoin Test Suite

#include "test_bpgcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bpgcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
