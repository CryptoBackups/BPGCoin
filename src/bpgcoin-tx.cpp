...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BPG Coin bpgcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bpgcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bpgcoin transaction") + "\n" +
              "  bpgcoin-tx [options] -create [commands]   " + _("Create hex-encoded bpgcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bpgcoin transaction
